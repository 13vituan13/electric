            ...
            <div class="box_container pd50">
                ...
                <div class="page_load overflow">
                    <div class="wap_item_hact flex wrap">
                        ...
                        <div class="item_dv item_hact">
                            <a href="sua-dien-may-o-quan-binh-tan" title="sừa điện máy ở quận bình tân">
                                <p class="sp_img zoom_hinh">
                                    <img class="lazy" src="images/err.png"
                                        data-src="thumb/330x295/1/upload/news/5cd63b2f9a4f67113e5e-1437.jpg"
                                        alt="sừa điện máy ở quận bình tân" />
                                </p>
                                <div class="info_dichvu">
                                    <h3 class="sp_name  catchuoi2">sừa điện máy ở quận bình tân</h3>
                                </div>
                            </a>
                        </div>
                        <div class="item_dv item_hact">
                            <a href="cong-trinh-quan-7" title="công trình quận 7">
                                <p class="sp_img zoom_hinh">
                                    <img class="lazy" src="images/err.png"
                                        data-src="thumb/330x295/1/upload/news/69da4ac609a6f4f8adb7-7644.jpg"
                                        alt="công trình quận 7" />
                                </p>
                                <div class="info_dichvu">
                                    <h3 class="sp_name  catchuoi2">công trình quận 7</h3>
                                </div>
                            </a>
                        </div>
                        <div class="item_dv item_hact">
                            <a href="di-doi-may-khu-cong-nghiep-phuc-long-long-an"
                                title="di dời máy khu công nghiệp phúc long long an">
                                <p class="sp_img zoom_hinh">
                                    <img class="lazy" src="images/err.png"
                                        data-src="thumb/330x295/1/upload/news/f87c216066009b5ec211-7872.jpg"
                                        alt="di dời máy khu công nghiệp phúc long long an" />
                                </p>
                                <div class="info_dichvu">
                                    <h3 class="sp_name  catchuoi2">di dời máy khu công nghiệp phúc long long an</h3>
                                </div>
                            </a>
                        </div>
                        <div class="item_dv item_hact">
                            <a href="sua-dien-binh-tan" title="sửa điện bình tân">
                                <p class="sp_img zoom_hinh">
                                    <img class="lazy" src="images/err.png"
                                        data-src="thumb/330x295/1/upload/news/31-7122.jpg" alt="sửa điện bình tân" />
                                </p>
                                <div class="info_dichvu">
                                    <h3 class="sp_name  catchuoi2">sửa điện bình tân</h3>
                                </div>
                            </a>
                        </div>
                    </div>
